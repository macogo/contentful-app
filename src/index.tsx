...
if (process.env.NODE_ENV === "development" && window.self === window.top) {
  ...
  init((sdk) => {
    ...
    const ENVMAPPING: { [key: string]: string } = {
      'prd': 'https://vistanova.com/',
      'uat': 'https://next-uat.vistanova.com/',
      'dev': 'https://next-sit.vistanova.com/',
    };
    const environment: string = sdk.ids?.environment || 'dev';
    const ENVURL: string = ENVMAPPING[environment];
    ...
    const ComponentLocationSettings = [
      ...
      },
      {
        ...
        component: <Sidebar sdk={sdk as SidebarExtensionSDK} {...{ ENVURL }} />,
      },
      {
